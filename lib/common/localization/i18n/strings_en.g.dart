...
class TranslationsScreenEn {
  ...
  // Translations
  late final TranslationsScreenHomeEn home = TranslationsScreenHomeEn.internal(
    _root,
  );
  late final TranslationsScreenSettingsEn settings =
      TranslationsScreenSettingsEn.internal(_root);
}
...
class TranslationsSystemEn {
  ...
  // Translations
  late final TranslationsSystemThemeEn theme =
      TranslationsSystemThemeEn.internal(_root);
  late final TranslationsSystemLangEn lang = TranslationsSystemLangEn.internal(
    _root,
  );
  late final TranslationsSystemBrightEn bright =
      TranslationsSystemBrightEn.internal(_root);
  late final TranslationsSystemShareEn share =
      TranslationsSystemShareEn.internal(_root);
}
...
class TranslationsScreenHomeEn {
  ...
  late final TranslationsScreenHomeAddCardEn addCard =
      TranslationsScreenHomeAddCardEn.internal(_root);
  late final TranslationsScreenHomeOpenCardEn openCard =
      TranslationsScreenHomeOpenCardEn.internal(_root);
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'screen.home.addCard.barcodeScan':
        return 'position barcode within frame to scan automatically';
