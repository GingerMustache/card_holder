...
class _TranslationsFromDeveloperRu extends TranslationsFromDeveloperEn {
	...
	@override String get feedback => 'Буду рад, если вы оставите комментарий на платформе, где скачали приложение. Также я всегда открыт для предложений по улучшению или ухудшению приложения.';
	...
	@override String get addCardDescription4 => 'Добавить карту из файла можно, просто открыв файл, которым с вами поделились, через данное приложение или с помощью него.';
	...
	@override String get shareCardsDescription3 => 'Ваш товарищ сможет скачать его и добавить карту через функцию добавления карты из файла, о которой говорилось выше.';
	@override String get shareCardsDescription4 => 'Также карточкой можно поделиться в виде фото. Да, тут можно заметить «А кто мне мешает сделать скриншот?» Согласен, но кто мне мешает сделать такую функцию?';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'fromDeveloper.feedback': return 'Буду рад, если вы оставите комментарий на платформе, где скачали приложение. Также я всегда открыт для предложений по улучшению или ухудшению приложения.';
			...
			case 'fromDeveloper.addCardDescription4': return 'Добавить карту из файла можно, просто открыв файл, которым с вами поделились, через данное приложение или с помощью него.';
			...
			case 'fromDeveloper.shareCardsDescription3': return 'Ваш товарищ сможет скачать его и добавить карту через функцию добавления карты из файла, о которой говорилось выше.';
			case 'fromDeveloper.shareCardsDescription4': return 'Также карточкой можно поделиться в виде фото. Да, тут можно заметить «А кто мне мешает сделать скриншот?» Согласен, но кто мне мешает сделать такую функцию?';
